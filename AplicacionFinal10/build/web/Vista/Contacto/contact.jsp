	...
	<!--header-->
		...
		<div class="content">
			...
			<div class="contact-w3l">
				<div class="container">
					<h2 class="tittle">CONTACTENOS</h2>
					
					<div class="col-md-4 contact-left">
						<div class="contct-info">
							<h4> INFORMACION DE CONTACTO</h4>
							<p>Su solicitud de información es importante para nosotros, así que tómese un momento para llenar y enviar este formulario..</p>
							<ul>
								<li>Celular : 970-616-267</li>
								<li>Telephone : 784 58926</li>
							...
							<form action="#" method="post">
								<div class="row">
									...
									<input type="text" name="Name" placeholder="NOMBRE" required>
										...
										<div class="col-md-6 row-grid">
											<input type="text" name="Email" placeholder="CORREO example@gmail.com" required>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="row">
									...
									<input type="text" name="Subject" placeholder="Subject" required>
										...
										<div class="col-md-6 row-grid">
									<input type="text" name="Subject" placeholder="NUMERO" required>
									</div>
									<div class="clearfix"></div>
								</div>
