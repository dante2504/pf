	...
	<!--header-->
		...
		<div class="content">
						...
						<div class="col-md-6 about-grid">
						 <h4>Nuestro Comienzo</h4>
							 <p>El grupo de estudios GRUPO CERO nace un 2 de diciembre del 2017 fundada por los alumnos estudiantes
                                                             ...
                                                             utilizada por algunos colegios de nivel inicial y primario en el país pero 
                                                             orientada más a los  cursos de números, buescando obtener un gran éxito es del año escolar.</p>
			...
			<!--statistics--->
				...
				<div class="staff-w3l">
					<div class="container">
						<h3 class="tittle">Nuestros colaboradores</h3>
